...
abstract contract VRC25 is IVRC25, IERC165 {
    ...
    mapping(bytes4 => bool) private _isUnlock;
    mapping(bytes4 => uint256) private _unlockAts;
    ...
    function acceptOwnership() external virtual {
        ...
        _owner = _newOwner;
        _newOwner = address(0);
        emit IssuerTransferred(oldOwner, _owner);
    }
     ...
     */
    function unlock(bytes4 _functionSign) external virtual onlyOwner {
